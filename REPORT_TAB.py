...
"border-color: rgb(0, 0, 0);")
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.RPRT_F_5)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.label_3 = QtWidgets.QLabel(self.RPRT_F_5)
        font = QtGui.QFont()
        font.setPointSize(7)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.verticalLayout_2.addWidget(self.label_3)
        self.label_5 = QtWidgets.QLabel(self.RPRT_F_5)
        font = QtGui.QFont()
        font.setPointSize(7)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.verticalLayout_2.addWidget(self.label_5)
        self.label_2 = QtWidgets.QLabel(self.RPRT_F_5)
        font = QtGui.QFont()
        font.setPointSize(7)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.verticalLayout_2.addWidget(self.label_2)
        self.label_4 = QtWidgets.QLabel(self.RPRT_F_5)
        font = QtGui.QFont()
        font.setPointSize(7)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.verticalLayout_2.addWidget(self.label_4)
        self.label = QtWidgets.QLabel(self.RPRT_F_5)
        font = QtGui.QFont()
        font.setPointSize(7)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "IO: Initiative Owner"))
        self.label_5.setText(_translate("MainWindow", "GNA: Global Network Analytics"))
        self.label_2.setText(_translate("MainWindow", "CF: Cross-Functional"))
        self.label_4.setText(_translate("MainWindow", "BT: Business Technology"))
        self.label.setText(_translate("MainWindow", "BT DNA: Business Technology Data Analysis"))
