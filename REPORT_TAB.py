...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.RPRT_F_3.setStyleSheet("background-color: rgb(63, 126, 167);\n"
"border-color: rgb(0, 0, 0);")
        ...
        self.RPRT_TBL_1.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.RPRT_TBL_1.setAlternatingRowColors(True)
        ...
        self.report_main_GL.addWidget(self.RPRT_TBL_1, 2, 0, 1, 1, QtCore.Qt.AlignHCenter)
        self.RPRT_F_4 = QtWidgets.QFrame(self.report_main)
        self.RPRT_F_4.setStyleSheet("background-color: rgb(63, 126, 167);")
        ...
        self.RPRT_F_2.setStyleSheet("background-color: rgb(63, 126, 167);")
        ...
        self.RPRT_F_5_vl = QtWidgets.QVBoxLayout(self.RPRT_F_5)
        self.RPRT_F_5_vl.setObjectName("RPRT_F_5_vl")
        self.RPRT_F_5_l3 = QtWidgets.QLabel(self.RPRT_F_5)
        font = QtGui.QFont()
        font.setPointSize(7)
        self.RPRT_F_5_l3.setFont(font)
        self.RPRT_F_5_l3.setObjectName("RPRT_F_5_l3")
        self.RPRT_F_5_vl.addWidget(self.RPRT_F_5_l3)
        self.RPRT_F_5_l5 = QtWidgets.QLabel(self.RPRT_F_5)
        font = QtGui.QFont()
        font.setPointSize(7)
        self.RPRT_F_5_l5.setFont(font)
        self.RPRT_F_5_l5.setObjectName("RPRT_F_5_l5")
        self.RPRT_F_5_vl.addWidget(self.RPRT_F_5_l5)
        self.RPRT_F_5_l2 = QtWidgets.QLabel(self.RPRT_F_5)
        font = QtGui.QFont()
        font.setPointSize(7)
        self.RPRT_F_5_l2.setFont(font)
        self.RPRT_F_5_l2.setObjectName("RPRT_F_5_l2")
        self.RPRT_F_5_vl.addWidget(self.RPRT_F_5_l2)
        self.RPRT_F_5_l4 = QtWidgets.QLabel(self.RPRT_F_5)
        font = QtGui.QFont()
        font.setPointSize(7)
        self.RPRT_F_5_l4.setFont(font)
        self.RPRT_F_5_l4.setObjectName("RPRT_F_5_l4")
        self.RPRT_F_5_vl.addWidget(self.RPRT_F_5_l4)
        self.RPRT_F_5_l1 = QtWidgets.QLabel(self.RPRT_F_5)
        font = QtGui.QFont()
        font.setPointSize(7)
        self.RPRT_F_5_l1.setFont(font)
        self.RPRT_F_5_l1.setObjectName("RPRT_F_5_l1")
        self.RPRT_F_5_vl.addWidget(self.RPRT_F_5_l1)
        self.report_main_GL.addWidget(self.RPRT_F_5, 0, 0, 2, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.RPRT_TBL_1.item(0, 0)
        item.setText(_translate("MainWindow", "DG-0001"))
        item = self.RPRT_TBL_1.item(0, 1)
        item.setText(_translate("MainWindow", "1234"))
        item = self.RPRT_TBL_1.item(0, 2)
        ...
        item = self.RPRT_TBL_4.item(0, 0)
        item.setText(_translate("MainWindow", "Y"))
        item = self.RPRT_TBL_4.item(0, 1)
        item.setText(_translate("MainWindow", "Y"))
        item = self.RPRT_TBL_4.item(0, 2)
        item.setText(_translate("MainWindow", "Y"))
        item = self.RPRT_TBL_4.item(0, 3)
        item.setText(_translate("MainWindow", "Y"))
        item = self.RPRT_TBL_4.item(0, 4)
        item.setText(_translate("MainWindow", "Y"))
        ...
        item = self.RPRT_TBL_3.item(0, 0)
        item.setText(_translate("MainWindow", "Y"))
        item = self.RPRT_TBL_3.item(0, 1)
        item.setText(_translate("MainWindow", "Y"))
        item = self.RPRT_TBL_3.item(0, 2)
        item.setText(_translate("MainWindow", "Y"))
        item = self.RPRT_TBL_3.item(0, 3)
        item.setText(_translate("MainWindow", "Y"))
        item = self.RPRT_TBL_3.item(0, 4)
        item.setText(_translate("MainWindow", "Y"))
        ...
        item = self.RPRT_TBL_2.item(0, 0)
        item.setText(_translate("MainWindow", "Y"))
        item = self.RPRT_TBL_2.item(0, 1)
        item.setText(_translate("MainWindow", "N"))
        item = self.RPRT_TBL_2.item(0, 2)
        item.setText(_translate("MainWindow", "N"))
        self.RPRT_TBL_2.setSortingEnabled(__sortingEnabled)
        self.RPRT_F_1_L.setText(_translate("MainWindow", "DG Initiative status"))
        self.RPRT_F_5_l3.setText(_translate("MainWindow", "IO: Initiative Owner"))
        self.RPRT_F_5_l5.setText(_translate("MainWindow", "GNA: Global Network Analytics"))
        self.RPRT_F_5_l2.setText(_translate("MainWindow", "CF: Cross-Functional"))
        self.RPRT_F_5_l4.setText(_translate("MainWindow", "BT: Business Technology"))
        self.RPRT_F_5_l1.setText(_translate("MainWindow", "BT DNA: Business Technology Data Analysis"))
